...
<html lang="ja">
  ...
  <body>
    ...
    <form action="/todo/index.php" method="post" name="form1" class="text-center">
      <input type="text" name="todotext" maxlength="20" class=" form-control my-3 bg-transparent text-white border-white" id="text" placeholder="１〜２０文字以内で入力してください。">
    ...
    if(isset($_POST['insert'])) {
      if( empty($_POST['todotext']) || mb_strlen($_POST['todotext']) > 20 ) {
        // $errors['todotext'] = '';
